...
- **[hexianWeb/isgalaxias](https://github.com/hexianWeb/isgalaxias)** — 银河 / 宇宙可视化项目，其深空氛围与星系外观为本项目的视觉方向提供了参考。
- **[17881055/canvas-galaxy](https://github.com/17881055/canvas-galaxy)** — Canvas 星系背景实现，启发了本项目螺旋星系背景的粒子分布与配色思路。

### 特别感谢

感谢 **Hong-xi TAO**、**Yu-tong YANG** 和 **Zhi-shan LIU** 在开发过程中提供的支持与动力。
